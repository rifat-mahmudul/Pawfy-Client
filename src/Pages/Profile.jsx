...
const Profile = () => {
    ...
    return (
        <section className="pt-24 pb-16 sm:pb-0 min-h-screen flex items-center justify-center">

            <div className="xl:max-w-[1200px] max-w-[90%] mx-auto border border-purple-600 p-3 rounded-lg shadow-xl shadow-purple-300">
                
                <div className="border-2 rounded-full h-56 w-56 flex items-center justify-center border-dashed border-purple-500 mx-auto">
                    <img className="rounded-full h-52 w-52 mx-auto" src={user?.photoURL} alt="" />
                </div>
                ...
                <div className="text-center">
                    ...
                    <button 
                    onClick={toggleModal}
                    className="py-2 px-6 rounded-lg bg-purple-500 hover:bg-purple-600 transition text-white mt-3"
                    >Update Profile
                    </button>
                    <Link to={'/dashboard'}><p className="mt-3 text-sm text-blue-500">Go Dashboard</p></Link>
                </div>
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    ...
                    <form className="space-y-4" onSubmit={handleUpdate}>
                        ...
                        <button
                            disabled={loading}
                            type="submit"
                            className="px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-900 disabled:cursor-not-allowed"
                        >
