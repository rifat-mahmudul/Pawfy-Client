        ...
        <section className='min-h-screen flex items-center justify-center bg-gradient-to-b from-[#efadef00] via-[#8000804e] to-[#800080c5]'>
            ...
            <div className='max-w-[90%] xl:max-w-[1100px] mx-auto relative'>
                ...
                <div className='flex flex-col sm:flex-row items-center justify-between'>
                    ...
                    <div className='pt-20 sm:pt-36 lg:py-0 mb-14 sm:w-[55%]'>
                        <h1 className={`sm:text-5xl text-3xl max-w-2xl uppercase font-russo ${theme === 'light' ? 'text-gray-700' : 'text-gray-100'}`}>Give a Paw, Gain a Lifetime of Love</h1>
                    ...
                    <div className='sm:h-[350px] sm:w-[40%]'>
